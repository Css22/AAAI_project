...
from tofu.partition import *
from tofu.target import *
from tofu.source import *
...
if __name__ == '__main__':
    ...
    for source_task in args.src_dataset.split(','):
        ...
        cur_train_partition_loaders, cur_val_partition_loaders = contrast_source_envs(src_data, model, opt, args)
    ...
    train_partition(train_partition_loaders,
                         val_partition_loaders,
                         partition_model,
                         opt, args)
    ...
    evaluate_target_model(tar_data, model, args)
